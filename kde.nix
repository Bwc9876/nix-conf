{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-2ada7d28-8bc3-4864-b933-61260d40a06b" = [ ];
      "ActivityManager"."switch-to-activity-9200dd12-3682-4c6f-b22b-c497bfa98164" = [ ];
      ...
      "kmix"."mic_mute" = ["Meta+N" "Microphone Mute"];
      ...
      "yakuake"."toggle-window-state" = ["Launch Media" "Meta+T"];
    };
    configFile = {
      ...
      "dolphinrc"."Baloo KEditCommentDialog"."2 screens: Height" = 252;
      "dolphinrc"."Baloo KEditCommentDialog"."2 screens: Width" = 276;
      "dolphinrc"."ContextMenu"."ShowCopyMoveMenu" = true;
      "dolphinrc"."CreateDialog"."LastMimeType" = "application/x-compressed-tar";
      "dolphinrc"."ExtractDialog"."DVI-D-1 HDMI-A-1 Height 1920x1080 HDMI-A-1" = 560;
      "dolphinrc"."ExtractDialog"."DVI-D-1 HDMI-A-1 Width 1920x1080 HDMI-A-1" = 1280;
      ...
      "kactivitymanagerdrc"."activities"."2ada7d28-8bc3-4864-b933-61260d40a06b" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "2ada7d28-8bc3-4864-b933-61260d40a06b";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "893,598";
      "kdeglobals"."General"."BrowserApplication" = "firefoxdeveloperedition.desktop";
      ...
      "kdeglobals"."KShortcutsDialog Settings"."Dialog Size" = "823,480";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{f1a85b18-5f87-43b1-a16b-49ff2ff17257}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{0af95fd1-1295-4c88-8749-fb36586729e9}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{4e12fc23-0a45-4f1a-8b97-83df3f597553}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{dbc4ee36-7dd8-47cf-bb13-e4a920d4cfc6}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{0ed429a3-ad18-4fbc-a886-a131d880080a}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{bdc817e4-8a38-42b0-b380-01d12d0b002f}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{574df56f-b197-425c-8d69-586f1d9c2fdb}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/bean/Pictures/background.jpg";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/home/bean/Pictures/background.jpg";
      ...
      "kwinrc"."Desktops"."Id_1" = "9d8a0562-caa7-404f-bfa2-512bfeaab243";
      ...
      "kwinrc"."TabBox"."LayoutName" = "org.kde.breezedark.desktop";
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling.10b31eb2-60c5-54ec-97ff-d2a804f00558"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.163493ff-995b-5618-9ebf-0f0bd0baca40"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.57063c57-b081-5721-b7aa-287c72860632"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.61a9cda2-c784-5476-9585-83eaed337290"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.80c665cb-f8e9-517e-a4fb-7e79a269e4c9"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.c38de295-efb8-5eb9-81b6-4c6d2f8c64b3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "kwinrc"."org.kde.kdecoration2"."ButtonsOnRight" = "LNIAX";
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmanotifyrc"."Notifications"."PopupPosition" = "TopCenter";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/bean/Pictures/background.jpg,/home/bean/Pictures/background-flipped.jpg";
